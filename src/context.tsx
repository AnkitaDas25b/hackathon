...
const AppContext = createContext<AppContextType>({
  ...
  markRadiologistReviewed: () => {}, markStudyUploaded: () => {}, assignConsultant: () => {},   confirmDiagnosis: () => {}, registeredPatients: [], registerPatient: () => {},
})
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AppContext.Provider value={{ role, setRole, view, setView, selectedPatientId, setSelectedPatientId, modal, setModal, workflow, markRadiologistReviewed, markStudyUploaded, assignConsultant, confirmDiagnosis, registeredPatients, registerPatient }}>
      {children}
    </AppContext.Provider>
  )
}
